...
;let o=0;for(const n of e.children){if("TD"!==n.nodeName)continue;const e=this.columns[o];switch(++o,e.type){case"rank":s.elements.rank=n,s.rank=f(n.textContent),s.rank!==t&&++this.qualifiedCount;break;case"total":s.elements.total=n,s.total=a(n.textContent);break;case"nett":s.elements.net=n,s.net=a(n.textContent);break;case"race":s.results[e.index]=this.parseRaceScore(n)}}return s}parseSummaryRows(t){for(const e of t.children)"TR"===e.nodeName&&e.classList.contains("summaryrow")&&this.competitors.push(this.parseSummaryRow(e))}}const f=e=>null===e||e===t?t:parseFloat(e),d=t=>{const s="("===t.charAt(0),o=s?t.slice(1,-1):t,n=a(o),r=o.indexOf(" "),c=r<0?null:o.slice(r+1),i=null===c||(t=>!e.includes(t))(c);return{isCts:i,isDiscard:s,score:n,code:c}},p=t=>{var e;for(const o of t.competitors){const{elements:t,rank:n,results:r}=o;(null===(e=null==t?void 0:t.competitor)||void 0===e?void 0:e.parentElement)&&t.competitor.parentElement.insertBefore(t.competitor,null),
...
n&&!n.classList.contains("summarytitle");)if(n.classList.contains("summarycaption"))o.caption=null!==(s=n.textContent)&&void 0!==s?s:"";else if(n.classList.contains("summarytable")){const t=(c=n,(new m).parse(c));r=t.raceCount,o.qualifiedCount=t.qualifiedCount,o.competitors=t.competitors,o.resultsColumns=t.columns}var c;return o.races=h(o,r),o})(t);e&&s.push(e)})),{groups:s}}}const k=t=>{const{competitors:e,races:o,qualifiedCount:n}=t;for(let t=0;t<o.length;++t){const c=!0===(r=o[t]).isSailed&&r;if(c)for(const o of e){const e=s(o.results[t]);!1!==e&&("DNC"===e.code&&(e.score=10*(Math.max(n,c.ctsCount)+1)))}}var r};document.addEventListener("DOMContentLoaded",(()=>{const t=(e=document,(new N).parse(e));var e;for(const e of t.groups)k(e),r(e),p(e);(()=>{const t=document.querySelector(".seriestitle"),e=document.createElement("div");e.innerHTML="DNC scores are provisional based on the number of qualifiers.<br><small>Rescored by Count Only Qualifying Races effect v0.1.0-beta-01</small>",
