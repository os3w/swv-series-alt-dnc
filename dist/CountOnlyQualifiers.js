...
;s.elements={competitor:e};let o=0;for(const n of e.children){if("TD"!==n.nodeName)continue;const e=this.columns[o];switch(++o,e.type){case"rank":s.elements.rank=n,s.rank=f(n.textContent),s.rank!==t&&++this.qualifiedCount;break;case"total":s.elements.total=n,s.total=l(n.textContent);break;case"nett":s.elements.net=n,s.net=l(n.textContent);break;case"race":s.results[e.index]=this.parseRaceScore(n)}}return s}parseSummaryRows(t){for(const e of t.children)"TR"===e.nodeName&&e.classList.contains("summaryrow")&&this.competitors.push(this.parseSummaryRow(e))}}const f=e=>null===e||e===t?t:parseFloat(e),p=t=>{const e="("===t.charAt(0),o=e?t.slice(1,-1):t,n=l(o),r=o.indexOf(" "),c=r<0?null:o.slice(r+1);return{isCts:null===c||s(c),isDiscard:e,score:n,code:c}},h=t=>{var e;for(const s of t.competitors){const{elements:t,rank:n,results:r}=s;(null===(e=null==t?void 0:t.competitor)||void 0===e?void 0:e.parentElement)&&t.competitor.parentElement.insertBefore(t.competitor,null),
...
n&&!n.classList.contains("summarytitle");)if(n.classList.contains("summarycaption"))o.caption=null!==(s=n.textContent)&&void 0!==s?s:"";else if(n.classList.contains("summarytable")){const t=(c=n,(new d).parse(c));r=t.raceCount,o.qualifiedCount=t.qualifiedCount,o.competitors=t.competitors}var c;return o.races=C(o,r),o})(t);e&&s.push(e)})),{groups:s}}}const S=t=>{const{competitors:e,races:s,qualifiedCount:n}=t;for(let t=0;t<s.length;++t){const r=s[t];if(r.isSailed)for(const s of e){const e=o(s.results[t]);!1!==e&&("DNC"===e.code&&(e.score=Math.max(n,r.cameToStartArea)+1))}}};document.addEventListener("DOMContentLoaded",(()=>{const t=(e=document,(new k).parse(e));var e;for(const e of t.groups)S(e),c(e),h(e);(()=>{const t=document.querySelector(".seriestitle"),e=document.createElement("div");e.innerHTML="DNC scores are provisional based on the number of qualifiers.<br><small>Rescored by Count Only Qualifying Races effect v0.1.0-beta-01</small>",
